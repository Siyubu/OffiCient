...
public class CourseAddedFragment extends Fragment {
    private Course course;
    private AppCompatActivity activity;

    public CourseAddedFragment(AppCompatActivity activity, Course course) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_course_added, container, false);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activity.getSupportFragmentManager().beginTransaction().remove(CourseAddedFragment.this).commit();
